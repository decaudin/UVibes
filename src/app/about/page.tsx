...
export default function About() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-3/5 mx-auto my-20">
      <Image src="/uv.jpg" alt="sun-uv" width={249} height={100} className="mb-20 h-auto w-auto"/>
      ...
      <Link href="/uv-check" className="px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition">Check UV</Link>
    </div>
  )
}
