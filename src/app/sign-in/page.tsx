...
export default function SignIn() {
    ...
    return (
        <form className="flex flex-col items-center w-full xs:w-3/5 mx-auto border-2 border-gray-400 my-12 rounded-lg shadow-md">
            <h1 className="text-4xl my-12 font-bold">Sign In</h1>
