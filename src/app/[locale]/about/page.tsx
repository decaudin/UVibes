    ...
    return (
        <div className="flex flex-col items-center justify-center w-4/5 mx-auto my-20 md:w-3/5">
            ...
            <p className="leading-relaxed">
                {t.rich("aboutDescription", {openuvLink: (chunks) => <AboutHref href="https://www.openuv.io" chunks={chunks} />})}
            </p>
            <p className="leading-relaxed my-6">
                {t.rich("aboutDescriptionCoords", {
            ...
            <p className="leading-relaxed mb-16">
                {t.rich("aboutDescriptionCity", {strong: (chunks) => <strong>{chunks}</strong>})}
            </p>
